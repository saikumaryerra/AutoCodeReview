...
export const CONFIG_REGISTRY: ConfigKeyMetadata[] = [
    ...
    },
    {
        ...
        label: 'Auto-Post Review Comment',
        description: 'When enabled, automatically post the review summary as a comment on the PR after each successful review.',
        category: 'review',
        type: 'boolean',
        default: false,
        editable: true,
    ...
    },
    {
        ...
        label: 'Auto-Post: Skip Clean Reviews',
        description: 'When auto-post is enabled, skip posting for reviews with no findings (clean). Reduces PR noise.',
        category: 'review',
        type: 'boolean',
        default: true,
        editable: true,
    ...
    },
    {
        key: 'claude.model',
        label: 'Claude Model',
        description: "Which Claude model the reviewer uses. 'default' lets the Claude CLI choose. Applied immediately.",
        category: 'claude',
        type: 'enum',
        enumValues: ['default', 'opus', 'sonnet', 'haiku'],
        default: 'default',
        editable: true,
        requiresRestart: false,
        validation: z.enum(['default', 'opus', 'sonnet', 'haiku']),
        sensitive: false,
    },
    {
        key: 'server.apiPort',
